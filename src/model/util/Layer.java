...
public class Layer implements Serializable {
    ...
    private transient ThreadLocal<Vec> out = new ThreadLocal<>();
    ...
    public Vec evaluate(Vec i) {
        if (out == null) {
            out = new ThreadLocal<>();//при десириализации не инициализируется,поэтому пришлось добавить
        }
    ...
    public String toString() {
        ...
        sb.append("Layer >>> l2: ").append(l2).append(", size: ").append(size);
        return sb.toString();
    }
}
